...
import { Story, StoryChapter, VocabularyItem, UserProgress } from '@/types';
...
import { VocabularyCard } from '@/components/exercises';
...
type AppState = 'home' | 'story' | 'vocabulary' | 'progress' | 'grammar' | 'grammar-library' | 'episodes' | 'reader' | 'dashboard' | 'roadmap' | 'profile-progress' | 'profile-achievements' | 'profile-flashcards' | 'profile-settings' | 'profile-level' | 'about';
